...
uint8 collecting = 0;
uint8 lcd_cursor = 0;
uint8 keypad_value_processed = 0;
uint8 fractional_mode = 0 ;
float fractional_multiplier = 0.1;
float Ans = 0;
sint8 balance = 0;
uint8 is_display_on = 0;
...
int main() {
 ...
 while (1) {
  ...
  keypad_value = keypad_read_value();
    ...
    if ('C' == keypad_value){
    ...
    else if ((((unsigned char)((keypad_value)-'0')) < 10) || '.' == keypad_value){
        if (keypad_value == '.'){
            if (!fractional_mode){
                 fractional_mode = 1;
        ...
        keypad_value_processed = 1;
         ...
         keypad_value_processed = 1;
               ...
               ret = lcd_8bit_send_command(&lcd, 0x01);
               ret = lcd_8bit_send_command(&lcd, 0x08);
                is_display_on = 0;
               keypad_value_processed = 1;
