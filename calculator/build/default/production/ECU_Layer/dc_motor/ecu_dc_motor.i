...
# 19 "ECU_Layer/dc_motor/../../MCAL_Layer/GPIO/../std_libraries.h" 2
...
Std_ReturnType dc_motor_intialize(const dc_motor_t *_dc_motor){
    ...
    if(((void*)0) == _dc_motor){
        ...
        gpio_pin_intialize(&(_dc_motor->dc_motor_bin[0x00U]));
...
Std_ReturnType dc_motor_move_right(const dc_motor_t *_dc_motor){
    ...
    if(((void*)0) == _dc_motor){
        ...
        gpio_pin_write_logic(&(_dc_motor->dc_motor_bin[0x00U]), GPIO_HIGH);
        gpio_pin_write_logic(&(_dc_motor->dc_motor_bin[0x01U]), GPIO_LOW);
    }
    return ret;
}
...
Std_ReturnType dc_motor_move_left(const dc_motor_t *_dc_motor){
    ...
    if(((void*)0) == _dc_motor){
        ...
        gpio_pin_write_logic(&(_dc_motor->dc_motor_bin[0x00U]), GPIO_LOW);
        gpio_pin_write_logic(&(_dc_motor->dc_motor_bin[0x01U]), GPIO_HIGH);
    }
    return ret;
}
