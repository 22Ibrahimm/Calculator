...
FINAL_IMAGE=${DISTDIR}/calculator.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
else
...
SOURCEFILES_QUOTED_IF_SPACED=ECU_Layer/7-segments/ecu_seven_seg.c ECU_Layer/button/ecu_button.c ECU_Layer/Chr_LCD/ecu_chr_lcd.c ECU_Layer/dc_motor/ecu_dc_motor.c ECU_Layer/keypad/ecu_keypad.c ECU_Layer/LED/ecu_led.c ECU_Layer/relay/ecu_relay.c ECU_Layer/ecu_layer_init.c MCAL_Layer/GPIO/hal_gpio.c MCAL_Layer/device_config.c services/Stack/stack.c application.c Calculator.c

# Object Files Quoted if spaced
OBJECTFILES_QUOTED_IF_SPACED=${OBJECTDIR}/ECU_Layer/7-segments/ecu_seven_seg.p1 ${OBJECTDIR}/ECU_Layer/button/ecu_button.p1 ${OBJECTDIR}/ECU_Layer/Chr_LCD/ecu_chr_lcd.p1 ${OBJECTDIR}/ECU_Layer/dc_motor/ecu_dc_motor.p1 ${OBJECTDIR}/ECU_Layer/keypad/ecu_keypad.p1 ${OBJECTDIR}/ECU_Layer/LED/ecu_led.p1 ${OBJECTDIR}/ECU_Layer/relay/ecu_relay.p1 ${OBJECTDIR}/ECU_Layer/ecu_layer_init.p1 ${OBJECTDIR}/MCAL_Layer/GPIO/hal_gpio.p1 ${OBJECTDIR}/MCAL_Layer/device_config.p1 ${OBJECTDIR}/services/Stack/stack.p1 ${OBJECTDIR}/application.p1 ${OBJECTDIR}/Calculator.p1
POSSIBLE_DEPFILES=${OBJECTDIR}/ECU_Layer/7-segments/ecu_seven_seg.p1.d ${OBJECTDIR}/ECU_Layer/button/ecu_button.p1.d ${OBJECTDIR}/ECU_Layer/Chr_LCD/ecu_chr_lcd.p1.d ${OBJECTDIR}/ECU_Layer/dc_motor/ecu_dc_motor.p1.d ${OBJECTDIR}/ECU_Layer/keypad/ecu_keypad.p1.d ${OBJECTDIR}/ECU_Layer/LED/ecu_led.p1.d ${OBJECTDIR}/ECU_Layer/relay/ecu_relay.p1.d ${OBJECTDIR}/ECU_Layer/ecu_layer_init.p1.d ${OBJECTDIR}/MCAL_Layer/GPIO/hal_gpio.p1.d ${OBJECTDIR}/MCAL_Layer/device_config.p1.d ${OBJECTDIR}/services/Stack/stack.p1.d ${OBJECTDIR}/application.p1.d ${OBJECTDIR}/Calculator.p1.d

# Object Files
OBJECTFILES=${OBJECTDIR}/ECU_Layer/7-segments/ecu_seven_seg.p1 ${OBJECTDIR}/ECU_Layer/button/ecu_button.p1 ${OBJECTDIR}/ECU_Layer/Chr_LCD/ecu_chr_lcd.p1 ${OBJECTDIR}/ECU_Layer/dc_motor/ecu_dc_motor.p1 ${OBJECTDIR}/ECU_Layer/keypad/ecu_keypad.p1 ${OBJECTDIR}/ECU_Layer/LED/ecu_led.p1 ${OBJECTDIR}/ECU_Layer/relay/ecu_relay.p1 ${OBJECTDIR}/ECU_Layer/ecu_layer_init.p1 ${OBJECTDIR}/MCAL_Layer/GPIO/hal_gpio.p1 ${OBJECTDIR}/MCAL_Layer/device_config.p1 ${OBJECTDIR}/services/Stack/stack.p1 ${OBJECTDIR}/application.p1 ${OBJECTDIR}/Calculator.p1

# Source Files
SOURCEFILES=ECU_Layer/7-segments/ecu_seven_seg.c ECU_Layer/button/ecu_button.c ECU_Layer/Chr_LCD/ecu_chr_lcd.c ECU_Layer/dc_motor/ecu_dc_motor.c ECU_Layer/keypad/ecu_keypad.c ECU_Layer/LED/ecu_led.c ECU_Layer/relay/ecu_relay.c ECU_Layer/ecu_layer_init.c MCAL_Layer/GPIO/hal_gpio.c MCAL_Layer/device_config.c services/Stack/stack.c application.c Calculator.c
...
ifneq ($(INFORMATION_MESSAGE), )
	...
	${MAKE}  -f nbproject/Makefile-default.mk ${DISTDIR}/calculator.${IMAGE_TYPE}.${OUTPUT_SUFFIX}

MP_PROCESSOR_OPTION=18F4620
# ------------------------------------------------------------------------------------
# Rules for buildStep: compile
ifeq ($(TYPE_IMAGE), DEBUG_RUN)
${OBJECTDIR}/ECU_Layer/7-segments/ecu_seven_seg.p1: ECU_Layer/7-segments/ecu_seven_seg.c  nbproject/Makefile-${CND_CONF}.mk 
	@${MKDIR} "${OBJECTDIR}/ECU_Layer/7-segments" 
	@${RM} ${OBJECTDIR}/ECU_Layer/7-segments/ecu_seven_seg.p1.d 
	@${RM} ${OBJECTDIR}/ECU_Layer/7-segments/ecu_seven_seg.p1 
	${MP_CC} $(MP_EXTRA_CC_PRE) -mcpu=$(MP_PROCESSOR_OPTION) -c  -D__DEBUG=1  -mdebugger=none   -mdfp="${DFP_DIR}/xc8"  -fno-short-double -fno-short-float -memi=wordwrite -O0 -fasmfile -maddrqual=ignore -xassembler-with-cpp -mwarn=-3 -Wa,-a -DXPRJ_default=$(CND_CONF)  -msummary=-psect,-class,+mem,-hex,-file  -ginhx32 -Wl,--data-init -mno-keep-startup -mdownload -mno-default-config-bits $(COMPARISON_BUILD)  -std=c99 -gcoff -mstack=compiled:auto:auto:auto     -o ${OBJECTDIR}/ECU_Layer/7-segments/ecu_seven_seg.p1 ECU_Layer/7-segments/ecu_seven_seg.c 
	@-${MV} ${OBJECTDIR}/ECU_Layer/7-segments/ecu_seven_seg.d ${OBJECTDIR}/ECU_Layer/7-segments/ecu_seven_seg.p1.d 
	@${FIXDEPS} ${OBJECTDIR}/ECU_Layer/7-segments/ecu_seven_seg.p1.d $(SILENT) -rsi ${MP_CC_DIR}../  
...
${OBJECTDIR}/services/Stack/stack.p1: services/Stack/stack.c  nbproject/Makefile-${CND_CONF}.mk 
	@${MKDIR} "${OBJECTDIR}/services/Stack" 
	@${RM} ${OBJECTDIR}/services/Stack/stack.p1.d 
	@${RM} ${OBJECTDIR}/services/Stack/stack.p1 
	${MP_CC} $(MP_EXTRA_CC_PRE) -mcpu=$(MP_PROCESSOR_OPTION) -c  -D__DEBUG=1  -mdebugger=none   -mdfp="${DFP_DIR}/xc8"  -fno-short-double -fno-short-float -memi=wordwrite -O0 -fasmfile -maddrqual=ignore -xassembler-with-cpp -mwarn=-3 -Wa,-a -DXPRJ_default=$(CND_CONF)  -msummary=-psect,-class,+mem,-hex,-file  -ginhx32 -Wl,--data-init -mno-keep-startup -mdownload -mno-default-config-bits $(COMPARISON_BUILD)  -std=c99 -gcoff -mstack=compiled:auto:auto:auto     -o ${OBJECTDIR}/services/Stack/stack.p1 services/Stack/stack.c 
	@-${MV} ${OBJECTDIR}/services/Stack/stack.d ${OBJECTDIR}/services/Stack/stack.p1.d 
	@${FIXDEPS} ${OBJECTDIR}/services/Stack/stack.p1.d $(SILENT) -rsi ${MP_CC_DIR}../  
...
ifeq ($(TYPE_IMAGE), DEBUG_RUN)
${DISTDIR}/calculator.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk    
	@${MKDIR} ${DISTDIR} 
	${MP_CC} $(MP_EXTRA_LD_PRE) -mcpu=$(MP_PROCESSOR_OPTION) -Wl,-Map=${DISTDIR}/calculator.${IMAGE_TYPE}.map  -D__DEBUG=1  -mdebugger=none  -DXPRJ_default=$(CND_CONF)  -Wl,--defsym=__MPLAB_BUILD=1   -mdfp="${DFP_DIR}/xc8"  -fno-short-double -fno-short-float -memi=wordwrite -O0 -fasmfile -maddrqual=ignore -xassembler-with-cpp -mwarn=-3 -Wa,-a -msummary=-psect,-class,+mem,-hex,-file  -ginhx32 -Wl,--data-init -mno-keep-startup -mdownload -mno-default-config-bits -std=c99 -gcoff -mstack=compiled:auto:auto:auto        $(COMPARISON_BUILD) -Wl,--memorysummary,${DISTDIR}/memoryfile.xml -o ${DISTDIR}/calculator.${IMAGE_TYPE}.${DEBUGGABLE_SUFFIX}  ${OBJECTFILES_QUOTED_IF_SPACED}     
	@${RM} ${DISTDIR}/calculator.${IMAGE_TYPE}.hex 
	
	
else
${DISTDIR}/calculator.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk   
	@${MKDIR} ${DISTDIR} 
	${MP_CC} $(MP_EXTRA_LD_PRE) -mcpu=$(MP_PROCESSOR_OPTION) -Wl,-Map=${DISTDIR}/calculator.${IMAGE_TYPE}.map  -DXPRJ_default=$(CND_CONF)  -Wl,--defsym=__MPLAB_BUILD=1   -mdfp="${DFP_DIR}/xc8"  -fno-short-double -fno-short-float -memi=wordwrite -O0 -fasmfile -maddrqual=ignore -xassembler-with-cpp -mwarn=-3 -Wa,-a -msummary=-psect,-class,+mem,-hex,-file  -ginhx32 -Wl,--data-init -mno-keep-startup -mdownload -mno-default-config-bits -std=c99 -gcoff -mstack=compiled:auto:auto:auto     $(COMPARISON_BUILD) -Wl,--memorysummary,${DISTDIR}/memoryfile.xml -o ${DISTDIR}/calculator.${IMAGE_TYPE}.${DEBUGGABLE_SUFFIX}  ${OBJECTFILES_QUOTED_IF_SPACED}     
